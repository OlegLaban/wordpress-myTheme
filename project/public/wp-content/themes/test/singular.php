            ...
            <div class="left_content">
                <div class="single_page">
                    <ol class="breadcrumb">
                        ...
                        {
                             $arr = json_decode(bcn_display_json_ld(true), true)['itemListElement'];
                            $endItem = array_pop($arr);
                        }
                        ?>
                        <?php foreach ($arr as $item): ?>
                        <li><a href="<?php echo $item['item']['@id'] ?>"><?php echo $item['item']['name'] ?></a></li>
                        <?php  endforeach; ?>
                        <li class="active" ><?php echo $endItem['item']['name'] ?></li>
                    </ol>
                    ...
                    <div class="single_page_content">
                        <?php
                        //Объявляем атрибуты для изображения.
                            $attr = array(
                                    'class' => 'img-center'
                            );
                        //Выводим главное изображение поста.
